    ...
    metaItem: metaDetails.metaItem !== null && metaDetails.metaItem.content.type === 'Ready' ?
        {
            ...
            content: {
                ...
                content: {
                    ...
                    videos: metaDetails.metaItem.content.content.videos.map((video: any) => ({
                        ...video,
                        released: new Date(
...
const useMetaDetails = (urlParams: UrlParams): MetaDetails => {
    ...
    return useModelState({ model: 'meta_details', action, map }) as MetaDetails;
};
