...
const ItemPlaceholder = () => {
    return (
        <div className={'pointer-events-none relative flex flex-none flex-col overflow-hidden rounded-card border-[0.15rem] border-transparent bg-surface opacity-70'}>
            <div className={'relative flex h-14 flex-none items-center px-4'}>
                <div className={'h-[1.2rem] w-32 rounded-full bg-line'} />
            </div>
            <div className={'flex flex-auto flex-col'}>
                <div className={'relative flex h-12 flex-none flex-row items-center justify-between gap-4 px-4'}>
